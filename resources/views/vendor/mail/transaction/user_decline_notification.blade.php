            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: #ffffff; border-radius: 4px;">
                ...
                <tr>
                    <td style="padding: 20px;">
                        ...
                        <br>
                        <p>Hello!</p>
                        <p>We regret to inform you that your transaction with reference {{ $transaction->reference }}  has been cancelled.</p>
                        <ul>
                            ...
                            <li><strong>Reason:</strong> {{ $transaction->getMeta('reason')}}</li>
                        </ul>
                        <p>Please review the transaction and take appropriate action.</p>
                        <br>
                        <p>Regards,</p>
                        <p>Tranzie</p>
                    </td>
